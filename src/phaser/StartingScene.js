...
class StartingScene extends Phaser.Scene {
    ...
    create(){
      ...
      ;
      console.log(localStorage.key(realIndexOfOurPlayer) + " "+localStorage.getItem(localStorage.key(realIndexOfOurPlayer)));
      ...
      this.newGameButton.on('pointerdown', () => {
        ...
        //getting the current level for id.
          ...
          this.scene.start("GameScene",{name: localStorage.key(realIndexOfOurPlayer), id: localStorage.getItem(localStorage.key(realIndexOfOurPlayer)), level: 0, mode: "new"});
       });
       ...
       this.continueButton.on("pointerdown", () => {
         ...
         .then(json => {
           console.log(json);
           this.scene.start("GameScene",{name: localStorage.key(realIndexOfOurPlayer), id: localStorage.getItem(localStorage.key(realIndexOfOurPlayer)), level: json.currentLevel, mode: "continue"});
